...
//   return userEyeColor;
//   // const nameUserEyeColor = userEyeColor.map(user => user.name);
//   // console.log(nameUserEyeColor);
//   // return nameUserEyeColor
// };
...
//   const youngPeople = users.filter(user => user.age > minAge && user.age < maxAge);
...
//         const indexFriend = friends.indexOf(friend);
//         // console.log("friend:", friend, "index:", index, "indexFriend:", indexFriend);
...
//   const avaragePlaytimePlayer = player.playtime / player.gamePlayed;
//   console.log(acc + avaragePlaytimePlayer);
// }, 0);
...
// const calculateTotalBalance = users.reduce((acc, user) => {
//     console.log(acc);
